...
fn lookup_exact(m: &str) -> Option<FormantParams> {
    ...
    let p = match m {
        ...
        "A" | "A:" | "a" | "a:" => FormantParams::mono(V, 700.0,130.0, 1.0, 1220.0, 70.0, 0.9, 2600.0, 160.0, 0.7, 0.0, false, 0.0),
        "Q" | "O" | "O:" => FormantParams::mono(V,   600.0, 90.0, 1.0,  990.0,100.0, 0.9, 2570.0,  80.0, 0.7, 0.0, false, 0.0),
        ...
        "I@" => FormantParams::diph(400.0,1800.0,2570.0, 50.0,100.0,140.0, 470.0,1270.0,1540.0, 0.0),
        ...
        "T"         => FormantParams::mono(UV, 320.0,200.0, 0.0, 1290.0,200.0, 0.08, 2540.0,1000.0, 0.18, 0.2, false, 110.0),
        ...
        "D"         => FormantParams::mono(PV, 270.0, 80.0, 0.4, 1290.0,100.0, 0.10, 2540.0, 800.0, 0.20, 0.1, false, 100.0),
